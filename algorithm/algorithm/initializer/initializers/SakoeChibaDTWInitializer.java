 ...
 * Date: 26/Mar/2015
 * Time: 23:11
 * System Time: 11:11 PM
 */

public class SakoeChibaDTWInitializer extends AbstractInitializer implements IInitializer{
    private static final Logger LOGGER = Logger.getLogger(SakoeChibaDTWInitializer.class.getName());

    /**
     * class constructor
     */
    public SakoeChibaDTWInitializer() {
        super();
    }
    ...
    public static void main(String[] args) {
        SakoeChibaDTWInitializer test = new SakoeChibaDTWInitializer();

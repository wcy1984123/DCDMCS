...
public class Distance implements Comparable<Distance>, Cloneable {
    ...
    private Double distance; // distance from the left node
	private Double weight; // number of instances given the distance
    ...
    public Distance(Double distance) {
		this(distance, 1.0); // intialize as the left node with only one instance included
    }

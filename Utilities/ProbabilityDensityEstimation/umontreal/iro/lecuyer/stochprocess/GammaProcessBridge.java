...
public class GammaProcessBridge extends GammaProcess  {
    ...
    * same {@link RandomStream RandomStream}. Furthermore, the
    * parameters of the
    * {@link GammaGen GammaGen} and
    * {@link BetaGen BetaGen} objects are not
    ...
    * of the {@link GammaGen GammaGen} and
    * the {@link BetaGen BetaGen} to <TT>stream</TT>.
    * 
    */

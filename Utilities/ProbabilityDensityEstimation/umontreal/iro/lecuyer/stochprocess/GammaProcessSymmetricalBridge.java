...
public class GammaProcessSymmetricalBridge extends GammaProcessBridge  {
    ...
    * {@link GammaGen GammaGen} and for the
    * {@link BetaSymmetricalGen BetaSymmetricalGen}
    ...
    * {@link RandomStream RandomStream} included in
    * the {@link BetaSymmetricalGen BetaSymmetricalGen}
    * is sets to the one included in the
    * {@link GammaGen GammaGen} to avoid confusion.
    * This {@link RandomStream RandomStream} is then used to

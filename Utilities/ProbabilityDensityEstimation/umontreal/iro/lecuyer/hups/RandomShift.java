 ...
 * The {@link RandomStream RandomStream} is
 * stored internally. The method {@link #randomize(PointSet) randomize} simply
 * calls
 * {@link PointSet#addRandomShift(RandomStream) addRandomShift}<TT>(stream)</TT>.
 * 
 * <P>
...
public class RandomShift implements PointSetRandomization {
   ...
   /**
    * Sets the internal
    *   {@link RandomStream RandomStream} to  <TT>stream</TT>.
    * 

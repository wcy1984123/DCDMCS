                        ...
                        XYDataset dataset, int series, int item, CrosshairState crosshairState, int pass)
   {
      ...
      if (state.getInfo() != null) {
         ...
         if (entities != null) {
            ...
            Shape shape = orientation != PlotOrientation.VERTICAL ? ((Shape) (new Rectangle2D.Double(transY0 - (double)r, transX0 - (double)r, 2 * r, 2 * r))) : ((Shape) (new Rectangle2D.Double(transX0 - (double)r, transY0 - (double)r, 2 * r, 2 * r)));
            if (shape != null) {
               String tip = null;

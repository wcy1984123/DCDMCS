 ...
 * The {@link Class Class} class can be used to obtain
 ...
 * It provides a {@link Class#forName((String)) forName} static method converting
 * a string to a {@link Class Class}, but the given string
 ...
 * given to {@link Class#forName((String)) forName} to be converted into
 * {@link Class Class} objects.
 * Unfortunately, only
 ...
 * to a {@link Class Class} object and to generate a simple name
 * from a {@link Class Class} object, based on the import
 * rules.
 * 
 * <P>
...
public class ClassFinder implements Cloneable, java.io.Serializable {
    ...
    *  Each element of this list is a nested {@link List List} containing
    *  {@link String String}'s, each string containing the fully qualified
    ...
    *  This list may contain only {@link String String}'s
    ...
    *  and calls {@link Class#forName((String)) forName} <TT>(name)</TT>.

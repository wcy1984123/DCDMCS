...
public class RandomStreamManager {
    ...
    *  {@link Collections#unmodifiableList((List)) unmodifiableList}, can be assumed
   ...
   /**
    * Forwards to the
    *  {@link RandomStream#resetStartStream(()) resetStartStream} methods
   ...
   /**
    * Forwards to the
    *  {@link RandomStream#resetStartSubstream(()) resetStartSubstream} methods
    *  of all streams in the list.
    * 
    */
   ...
   /**
    * Forwards to the
    *  {@link RandomStream#resetNextSubstream(()) resetNextSubstream} methods
    *  of all streams in the list.
    * 
    */
